...
Auth is only configurable in the [Enterprise version](/docs/enterprise) of BuildBuddy.
...
## Google auth provider[](#google-auth-provider "Direct link to Google auth provider")
...
## Gitlab auth provider[](#gitlab-auth-provider "Direct link to Gitlab auth provider")
...
For more details, please refer to [Gitlab's latest Official Documentation](https://docs.gitlab.com/ee/integration/openid%5Fconnect%5Fprovider.html)
...
* First, register an Application on Gitlab side:  
   * For Gitlab SaaS, follow [Group-Owned Application Documentation](https://docs.gitlab.com/ee/integration/oauth%5Fprovider.html#create-a-group-owned-application) instructions.  
   * For Gitlab On-Prem, follow [Instance-Wide Application Documentation](https://docs.gitlab.com/ee/integration/oauth%5Fprovider.html#create-a-group-owned-application) instructions.
