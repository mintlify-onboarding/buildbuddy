...
## Configuration options as flags[](#configuration-options-as-flags "Direct link to Configuration options as flags")

Additionally any [configuration option](/docs/config) can also be specified as a flag instead using dot notation.
