...
## Installing the repo[](#installing-the-repo "Direct link to Installing the repo")
...
The command deploys BuildBuddy on the Kubernetes cluster in the default configuration. The [configuration](#configuration)section lists the parameters that can be configured during installation.

## Uninstalling the Chart[](#uninstalling-the-chart "Direct link to Uninstalling the Chart")
...
## Updating your release[](#updating-your-release "Direct link to Updating your release")
...
## Writing deployment to a file[](#writing-deployment-to-a-file "Direct link to Writing deployment to a file")
...
### Example MySQL configuration[](#example-mysql-configuration "Direct link to Example MySQL configuration")
...
### Example external database configuration[](#example-external-database-configuration "Direct link to Example external database configuration")
...
### Example ingress and certs configuration[](#example-ingress-and-certs-configuration "Direct link to Example ingress and certs configuration")
...
## Example with auth (required for enterprise features)[](#example-with-auth-required-for-enterprise-features "Direct link to Example with auth (required for enterprise features)")
...
## Example with remote build execution[](#example-with-remote-build-execution "Direct link to Example with remote build execution")
