...
## GetInvocation[](#getinvocation "Direct link to GetInvocation")
...
### Example cURL response[](#example-curl-response "Direct link to Example cURL response")
...
### GetInvocationRequest[](#getinvocationrequest "Direct link to GetInvocationRequest")
...
### GetInvocationResponse[](#getinvocationresponse "Direct link to GetInvocationResponse")
...
### InvocationSelector[](#invocationselector "Direct link to InvocationSelector")
...
## GetLog[](#getlog "Direct link to GetLog")
...
### Service[](#service-1 "Direct link to Service")
...
### Example cURL response[](#example-curl-response-1 "Direct link to Example cURL response")
...
### GetLogRequest[](#getlogrequest "Direct link to GetLogRequest")
...
### GetLogResponse[](#getlogresponse "Direct link to GetLogResponse")
...
### LogSelector[](#logselector "Direct link to LogSelector")
...
## GetTarget[](#gettarget "Direct link to GetTarget")
...
### Endpoint[](#endpoint-2 "Direct link to Endpoint")
...
### Service[](#service-2 "Direct link to Service")
...
### Example cURL response[](#example-curl-response-2 "Direct link to Example cURL response")
...
### GetTargetRequest[](#gettargetrequest "Direct link to GetTargetRequest")
...
### GetTargetResponse[](#gettargetresponse "Direct link to GetTargetResponse")
...
### TargetSelector[](#targetselector "Direct link to TargetSelector")
...
## GetAction[](#getaction "Direct link to GetAction")
...
### Endpoint[](#endpoint-3 "Direct link to Endpoint")
...
### Service[](#service-3 "Direct link to Service")
...
### Example cURL request[](#example-curl-request-3 "Direct link to Example cURL request")
...
### Example cURL response[](#example-curl-response-3 "Direct link to Example cURL response")
...
### GetActionRequest[](#getactionrequest "Direct link to GetActionRequest")
...
### GetActionResponse[](#getactionresponse "Direct link to GetActionResponse")
...
### ActionSelector[](#actionselector "Direct link to ActionSelector")
...
## GetFile[](#getfile "Direct link to GetFile")
...
### Endpoint[](#endpoint-4 "Direct link to Endpoint")
...
### Service[](#service-4 "Direct link to Service")
...
### Example cURL request[](#example-curl-request-4 "Direct link to Example cURL request")
...
### Example cURL response[](#example-curl-response-4 "Direct link to Example cURL response")
...
### GetFileRequest[](#getfilerequest "Direct link to GetFileRequest")
...
### GetFileResponse[](#getfileresponse "Direct link to GetFileResponse")
...
The `DeleteFile` endpoint allows you to delete a specific cache entry, which is associated with a uri. This can be used to address cache poisoning.

### Endpoint[](#endpoint-5 "Direct link to Endpoint")
...
### Service[](#service-5 "Direct link to Service")
...
### Example cURL request[](#example-curl-request-5 "Direct link to Example cURL request")
...
### DeleteFileRequest[](#deletefilerequest "Direct link to DeleteFileRequest")
...
### DeleteFileResponse[](#deletefileresponse "Direct link to DeleteFileResponse")
...
## ExecuteWorkflow[](#executeworkflow "Direct link to ExecuteWorkflow")

The `ExecuteWorkflow` endpoint lets you trigger a Buildbuddy Workflow for the given repository and branch.

Note: Github App authentication is required. The API does not support running legacy workflows. See[https://www.buildbuddy.io/docs/workflows-setup/](https://www.buildbuddy.io/docs/workflows-setup/) for more information on how to setup workflows with Github App authentication.

### Endpoint[](#endpoint-6 "Direct link to Endpoint")
...
### Service[](#service-6 "Direct link to Service")
...
### Example cURL request[](#example-curl-request-6 "Direct link to Example cURL request")
...
### ExecuteWorkflowRequest[](#executeworkflowrequest "Direct link to ExecuteWorkflowRequest")
...
### ExecuteWorkflowResponse[](#executeworkflowresponse "Direct link to ExecuteWorkflowResponse")
