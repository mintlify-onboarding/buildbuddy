...
[Platforms](/docs/rbe-platforms) can be used to specify custom Docker images in which to run your actions, but sometimes you want control over more properties of the executor machine - like available memory, access to GPUs, or physical location.
...
## Deploying executors in a pool[](#deploying-executors-in-a-pool "Direct link to Deploying executors in a pool")
...
## Setting the app's default pool name[](#setting-the-apps-default-pool-name "Direct link to Setting the app's default pool name")
...
## Selecting a pool to run your builds on[](#selecting-a-pool-to-run-your-builds-on "Direct link to Selecting a pool to run your builds on")
...
### Platform level[](#platform-level "Direct link to Platform level")
...
### Target level[](#target-level "Direct link to Target level")
