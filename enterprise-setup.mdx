...
For more instructions on deploying RBE, see our [enterprise on-prem RBE docs](/docs/enterprise-rbe).
...
For configuration options, see [RBE config documentation](/docs/config-rbe).
...
For more details on using the `k8s_on_prem.sh` script, see the [Kubernetes section](/docs/on-prem#kubernetes) of the on-prem deployment documentation.

## Configuring BuildBuddy[](#configuring-buildbuddy "Direct link to Configuring BuildBuddy")

For documentation on BuildBuddy enterprise configuration options, check out our [enterprise configuration documentation](/docs/enterprise-config).